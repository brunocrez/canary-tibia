local internalNpcName = "Pablo Escobar"
...
npcConfig.shop = {
	...
	{ itemName = "ice rapier", clientId = 3284, sell = 1500 },
	...
	{ itemName = "magicians robe", clientId = 7991 },
...
npcHandler:setMessage(MESSAGE_GREET, "Plata o Pomo?")
npcHandler:setMessage(MESSAGE_FAREWELL, "Hijo de puta madre, mal parido!")
npcHandler:setMessage(MESSAGE_WALKAWAY, "La concha de tu madre!")
npcHandler:setMessage(MESSAGE_SENDTRADE, "Vou mandar botar platina no seu nariz.")
