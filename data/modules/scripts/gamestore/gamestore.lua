...
GameStore.Categories = {
	...
	-- Consumables
	{
		...
		name = "Consumables",
		rookgaard = true,
		subclasses = { "Casks", "Kegs", "Exercise Weapons", "Potions", "Runes" },
	},
	-- Consumables ~ Casks
	{
	...
	-- Consumables ~ Exercise Weapons
	{
		...
		offers = {
			...
			-- Lastings
			{
				...
				itemtype = 35286,
				charges = 17000,
				description = "<i>Use it to train your axe fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your axe fighting skill\n{info} usable 17000 times a piece",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				icons = { "Exercise_Bow.png" },
	...
	-- Extras ~ Usefull Things
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 23721,
				count = 1,
				description = "<i>Carries as many gold, platinum or crystal coins and all sorts of items as your capacity allows.</i>\n\n{character}\n{storeinbox}\n{once}\n{useicon} use it to open it\n{info} always placed on the first position of your Store inbox",
